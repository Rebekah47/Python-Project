...
transaction_1 = Transaction(account_1, merchant_1, 14.95, "25-09-2020", tag_1)
transaction_repository.save_transaction(transaction_1)
transaction_2 = Transaction(account_1, merchant_2, 22.50, "27-09-2020", tag_2)
transaction_repository.save_transaction(transaction_2)
transaction_3 = Transaction(account_1, merchant_3, 120, "30-08-2020", tag_3)
